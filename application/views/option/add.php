            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addBooking" action="<?php echo base_url() ?>Option/addemoji" method="post" role="form" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">                                
                                ...
                                <div class="col-md-12">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo set_value('option'); ?>" id="name" name="option" maxlength="256" />
                                    </div>
                                 ...
                                 <div class="col-md-12">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo set_value('option_order'); ?>" id="name" name="option_order" maxlength="256" />
                                    </div>
...
function getZone(electionId) {
    $.ajax({
        url: '<?php echo base_url(); ?>option/getQuestions', // URL of the delete method in the controller
        type: 'POST',
        data: {
