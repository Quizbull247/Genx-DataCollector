            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>emoji/editemoji" method="post" id="editBooking" role="form" enctype="multipart/form-data">
                        <div class="box-body">
                        <div class="row">
                                <div class="col-md-12">                                
                                ...
                                <div class="col-md-12">                                
                                    <div class="form-group">
                                        ...
                                        <img src="<?php echo base_url(); ?>uploads/emoji/<?php echo $image ?>" style="width:50px;">
