<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i>ZC User Management
        <small>Add / Edit ZC User</small>
      </h1>
    </section>
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="<?php echo base_url() ?>user/addNewUseradminzc" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                ...
                                <div class="col-md-6">
                                  ...
                                  <div class="col-md-6" >
                                    <div class="form-group">
                                        ...
                                        ZC
                                        <input type="hidden" class="form-control required" value="3" id="role" name="role">
                            ...
                            <div class="row">
                                <div class="col-md-6" >
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="election" required name="election" onchange="getZone(this.value)">
                               ...
                               <div class="row">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="qc_id">
...
function getZone(electionId) {
    $.ajax({
        ...
        success: function(response) {
            ...
            qc_idSelect.innerHTML = ''; // Clear existing options
