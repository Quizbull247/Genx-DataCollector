        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>user/addNewQC"><i class="fa fa-plus"></i> Add New QC</a>
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>user/addNewZC"><i class="fa fa-plus"></i> Add New ZC</a>
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>user/addNewOT"><i class="fa fa-plus"></i> Add New OT</a>
                    <?php }else{ ?>
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td><?php echo $record->role; if($record->roleStatus == INACTIVE) { echo ' <br><span class="label label-warning">Inactive</span>'; } ?></td>
						  <td><?php $zoneId =  $record->zoneId;
						  $q=$this->db->query("SELECT * FROM `zone` WHERE `id`='$zoneId' ");
						  $row=$q->row();
						  if(!empty($row))
						  {
						      echo $row->name;
