<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i>QC  User Management
        <small>Add / Edit QC User</small>
      </h1>
    </section>
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="<?php echo base_url() ?>user/addNewUseradmin" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                            ...
                            <div class="row">
                               ...
                               <div class="col-md-6" >
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="election" name="election" onchange="getZone(this.value)" required>
                            ...
                            <div class="row">
                                 ...
                                 <div class="col-md-6" >
                                    <div class="form-group">
                                        ...
                                        QC<input type="hidden" class="form-control required" value="2" id="role" name="role">
