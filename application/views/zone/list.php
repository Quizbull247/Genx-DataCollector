<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-user-circle-o" aria-hidden="true"></i> Zone Management
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>Zone/add"><i class="fa fa-plus"></i> Add New Zone</a>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        $queryqr=$queryq->row();
                    ...
                    <tr>
                        ...
                        <a class="btn btn-sm btn-success"  style="    background-color: #00a65a !important; color:white" href="<?php echo base_url().'Zone/view/'.$record->id; ?>" title="Edit"><i class="fa fa-eye"></i></a>

                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'Zone/edit/'.$record->id; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
    ...
    if (confirm("Are you sure you want to delete this Zone?")) {
        $.ajax({
            url: '<?php echo base_url(); ?>Zone/delete', // URL of the delete method in the controller
            type: 'POST',
            data: {
                id: emojiId,
            },
...
function updatestatus(a,b){
    ...
    if (confirm("Are you sure you want to update this Zone?")) {
        $.ajax({
            url: '<?php echo base_url(); ?>Zone/update', // URL of the delete method in the controller
            type: 'POST',
            data: {
                id: b,
                 status: a,
