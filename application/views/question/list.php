        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>Question/add"><i class="fa fa-plus"></i> Add New Question</a>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        $queryqr=$queryq->row();
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                           <a class="btn btn-sm btn-success"  style="    background-color: #00a65a !important; color:white" href="<?php echo base_url().'Question/view/'.$record->id; ?>" title="Edit"><i class="fa fa-eye"></i></a>

                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'Question/edit/'.$record->id; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
    ...
    if (confirm("Are you sure you want to delete this Question?")) {
        $.ajax({
            url: '<?php echo base_url(); ?>Question/delete', // URL of the delete method in the controller
            type: 'POST',
            data: {
                id: emojiId,
            },
...
function updatestatus(a,b){
    ...
    if (confirm("Are you sure you want to update this Question?")) {
        $.ajax({
            url: '<?php echo base_url(); ?>question/update', // URL of the delete method in the controller
            type: 'POST',
            data: {
                id: b,
                 status: a,
