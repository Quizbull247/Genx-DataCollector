...
class Party extends BaseController
{
    ...
    {
        parent::__construct();
        $this->load->model('Party_model', 'bm');
        $this->isLoggedIn();
        $this->module = 'party';
    }
    ...
    function list()
    {
        ...
        else
        {
            ...
            $this->loadViews("party/list", $this->global, $data, NULL);
        }
    }
    ...
    function add()
    {
        ...
        else
        {
            ...
            $this->loadViews("party/add", $this->global, NULL, NULL);
        }
    }
    ...
    function edit($bookingId = NULL)
    {
        ...
        else
        {
            ...
            $this->loadViews("party/edit", $this->global, $data, NULL);
        }
    }
    function view($bookingId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'CodeInsect : Edit Party';
            
            $this->loadViews("party/view", $this->global, $data, NULL);
        }
    }
    ...
    public function delete()
{
    ...
    $this->load->model('Party_model'); // Load your model
    $result = $this->Party_model->deleteEmoji($id); // Assume deleteEmoji is a method in your model
