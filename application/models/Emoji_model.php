 ...
 * @since : 18 Jun 2022
 */
class Emoji_model extends CI_Model
{
    /**
    ...
    {
        $this->db->trans_start();
        $this->db->insert('emoji', $bookingInfo);
    ...
    {
        $this->db->where('id', $bookingId);
        $this->db->update('emoji', $bookingInfo);
...
{
    $this->db->where('id', $id);
    return $this->db->delete('emoji'); // Adjust 'emojis' to your actual table name
}
