...
class User_model extends CI_Model
{
     ...
     */
      ...
      public function countTodayFeedback() {
        $today = date('Y-m-d');
         if($this->session->userdata('role')==2){
        $this->db->where('qc_id', $this->session->userdata('userId'));
        }
        if($this->session->userdata('role')==3){
                $this->db->where('zc_id', $this->session->userdata('userId'));
           }
       ...
       public function countTotalFeedback() {
        ...
        public function countTotalOT($role) {
    ...
    {
        $this->db->select('BaseTbl.zoneId, BaseTbl.userId, BaseTbl.email, BaseTbl.name, BaseTbl.mobile, BaseTbl.isAdmin, BaseTbl.createdDtm, 
        ...
        if(!empty($searchText)) {
            ...
            if ($this->session->userdata('role') == 2) {
               $this->db->where('BaseTbl.qc_id',  $this->session->userdata('userId'));
                $this->db->where('BaseTbl.roleId', 3);
            }else if ($this->session->userdata('role') == 3) {
                 $this->db->where('BaseTbl.zc_id',  $this->session->userdata('userId'));
            }
